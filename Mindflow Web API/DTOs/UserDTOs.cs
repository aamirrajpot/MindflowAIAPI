namespace Mindflow_Web_API.DTOs
{
    ...
    public record UserProfileDto(Guid userId,string UserName, string Email, string? FirstName, string? LastName, DateTime? DateOfBirth, string? ProfilePic, bool QuestionnaireFilled, DateTime? AiConsentAtUtc, UserSubscriptionDto? ActiveSubscription = null, Guid? apple_app_account_token = null);
